...
- **Undeveloped-feature queue (2026-04-25)**: **`DEVELOPER_TODOS`** §0.4 now enumerates the remaining work (P0 batch `HM-02c` / `CC-03c` / `ECC-03b` → **Done**; P1 queue for Teams gateway, docker/SSH runtime, dashboard advanced interactions, gateway productization, plugin CI snapshot; OOS items with replacement pointers). Mirrored in **`ROADMAP_EXECUTION`** §10 and **`GAP_TRACKER.md`**.
- **Explore batch closed (HM-03c / ECC-03a / HM-06a / HM-07a)**: Added assessment/design RFCs under **`docs/rfc/`**: **`HM_03C_NEXT_GATEWAY_PLATFORMS.zh-CN.md`**, **`ECC_03A_PLUGIN_VERSION_GOVERNANCE.zh-CN.md`**, **`HM_06A_RUNTIME_BACKEND_ASSESSMENT.zh-CN.md`**, **`HM_07A_VOICE_BOUNDARY.zh-CN.md`**; roadmap §10 issues marked **Done** (document deliverables). **`DEVELOPER_TODOS`** §0.3.1 lists the ordered batch.
