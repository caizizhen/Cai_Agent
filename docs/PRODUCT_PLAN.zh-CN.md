...
*文档版本：2026-04-22（§二 S1-02：`schedule run-due`/`daemon --json` 增加 **`schedule_run_due_v1`** / **`schedule_daemon_summary_v1`**；`cost budget`/`sessions` 等见 schema README；T1 **334 passed**。）*
